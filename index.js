...
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:Hiraiya\n' 
            + 'ORG:Bot Recode.By.Hiraiya ;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6289603710955:+62 896-0371-0955\n' // Replace your number
            + 'END:VCARD'
prefix = '.'
blocked = []
...
*/
  ...
  const ownerNumber = [] // Your Number Example 6289603710955@s.whatsapp.net
...
break
case 'owner':
                  iky.sendMessage(from, {displayname: "", vcard: vcard}, MessageType.contact, { quoted: gay})
